...
字典与列表或者元组不同之处就在于 字典中的每个元素都是 key 和一个对应的 value

    >>> favorite_sports = {'Raplph Williams' : 'Footabll',
                       'Michael Tippett' : 'Basketball',
                       'Edward Elgar' : 'Baseball',
                       'Rebecca Clarke' : 'Badminton',
...
替换字典中的值：
    ...
    >>> favorite_sports['Michael Tippett'] = 'Ice Hockey'
    >>> print(favorite_sports)